...
import hypercard.gui.ButtonEditor;
import hypercard.gui.ButtonContextMenu;
...
private static final long serialVersionUID = 6441731559079090863L;
    ...
    public void editProperties () {
    	...
    	ButtonEditor fe = new ButtonEditor(RuntimeEnv.getRuntimeEnv().getMainWind(), properties);
    	fe.setVisible(true);    	
    }
