 ...
 * factors, etc. are all expressions. Contrast to {@link com.defano.hypertalk.ast.statement.Statement}.
 *
...
public abstract class Expression extends ASTNode {
     ...
     * {@link Breadcrumb} referring to the script token and script-owning part that
    ...
    public <T extends PartModel> T partFactor(ExecutionContext context, Class<T> clazz) {
        ...
        try {
            ...
            if (clazz.isAssignableFrom(model.getClass())) {
                ...
                PartExp refExp = ScriptExecutor.blockingDereference(partExp.evaluate(context), PartExp.class);
     ...
     * <p>
     * Evaluates this expression as a HyperTalk {@link Value}, then invokes the {@link ScriptExecutor} to re-parse the
    ...
    private <T extends Expression> T evaluateAs(ExecutionContext context, Class<T> klazz) {
        ...
        try {
            return ScriptExecutor.blockingDereference(this.evaluate(context), klazz);
        } catch (HtException e) {
            return null;
        }
    }
