...
public class ExpPartNumber extends ExpPart {

    public final PartLayer layer;
    public final PartType type;
    public final Expression number;

    public ExpPartNumber(PartLayer layer, Expression number) {
        this(layer, null, number);
    }

    public ExpPartNumber(PartLayer layer, PartType type, Expression number) {
        this.layer = layer;
        this.number = number;
        this.type = type;
    }
