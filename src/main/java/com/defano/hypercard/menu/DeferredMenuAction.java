...
public class DeferredMenuAction implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        delegatedActionExecutor.submit(() -> {
            ...
            HyperCard.getInstance().getActiveStackDisplayedCard().getCardModel().receiveMessage(SystemMessage.DO_MENU.messageName, ListExp.fromValues(null, new Value(theMenu), new Value(theMenuItem)), (command, wasTrapped, err) -> {
