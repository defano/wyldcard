...
import com.defano.wyldcard.part.field.FieldStyle;
...
public class FieldPropertyEditor extends WyldCardDialog<FieldModel> implements ActionBindable {
    ...
    private static final int PREVIEW_WIDTH = FieldPart.DEFAULT_WIDTH;
    private static final int PREVIEW_HEIGHT = FieldPart.DEFAULT_HEIGHT;
    ...
    public void bindModel(FieldModel data) {
        ...
        fieldHeight.setModel(new SpinnerNumberModel(10, 10, 9999, 1));
        fieldWidth.setModel(new SpinnerNumberModel(10, 10, 9999, 1));
        fieldTop.setModel(new SpinnerNumberModel(0, 0, 9999, 1));
        fieldLeft.setModel(new SpinnerNumberModel(0, 0, 9999, 1));
