...
public class BrushesPalette extends WyldCardDialog<Object> implements Consumer<PaintBrush> {
    ...
    private BrushesPalette() {
        ...
        square16.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.SQUARE_16X16));
        square12.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.SQUARE_12X12));
        square8.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.SQUARE_8X8));
        square4.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.SQUARE_4X4));
        round16.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.ROUND_16X16));
        round12.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.ROUND_12X12));
        round8.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.ROUND_8X8));
        round4.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.ROUND_4X4));
        line16.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.LINE_16));
        line12.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.LINE_12));
        line8.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.LINE_8));
        line4.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.LINE_4));
        forward16.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.FORWARD_16));
        forward12.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.FORWARD_12));
        forward8.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.FORWARD_8));
        forward4.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.FORWARD_4));
        back16.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.BACK_16));
        back12.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.BACK_12));
        back8.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.BACK_8));
        back4.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.BACK_4));
        bar16.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.BAR_16));
        bar12.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.BAR_12));
        bar8.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.BAR_8));
        bar4.addActionListener(a -> WyldCard.getInstance().getPaintManager().setSelectedBrush(PaintBrush.BAR_4));

        WyldCard.getInstance().getPaintManager().getSelectedBrushProvider().subscribe(this);
    }
