...
`debug checkpoint` | Causes execution of the script to pause and the HyperTalk debugger to open, highlighting this statement. Has no effect when executed from the message window. 
